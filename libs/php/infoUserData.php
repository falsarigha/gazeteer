<?php
    ...
    //$rc_url='https://api.opencagedata.com/geocode/v1/json?q=51.5072+0.1276&key=5df3b1b2e1e445c5b3324e85c816cbd0';
	$rc_ch = curl_init();
    ...
    $ow_url='https://api.openweathermap.org/data/2.5/onecall?lat=' . $_REQUEST['lat'] . '&lon=' . $_REQUEST['lng'] . '&units=metric&appid=e1c3308c9a1b6fff63552f064569a9a8';

    //$ow_url='https://api.openweathermap.org/data/2.5/onecall?lat=51.5072&lon=0.1276&units=metric&appid=e1c3308c9a1b6fff63552f064569a9a8';
    ...
    // GeoNamesWiki API
    $gnw_url='http://api.geonames.org/wikipediaBoundingBoxJSON?north=' . $geonames_info['north'] . '&south=' . $geonames_info['south'] . '&east=' . $geonames_info['east'] . '&west=' . $geonames_info['west'] . '&maxRows=10&username=falsarigha';
